...
export default function RoleSystem() {
  return (
    <div className={styles.wrap} role="img" aria-label="Three dimensional spheres connecting Architectural and Luxury Design, Bio-Designer and Creative Project Lead">
      ...
      {roles.map((role) => (
        <div key={role.key} className={`${styles.sphereWrap} ${styles[role.key]}`}>
