  ...
  return (
    <>
      <nav className="siteNav" aria-label="Primary navigation">
        ...
        {home ? (
          <a className="navContact navExperience" href="#home-journey"><span>LIVE</span> EXPERIENCE ↓</a>
        ) : (
      ...
      <nav className="mobileDock" aria-label="Mobile chapter navigation">
        <Link href="/" prefetch={false} className={home ? "isActive" : undefined} aria-label="Home"><span>00</span><b>BR</b></Link>
        {items.map(item => (
